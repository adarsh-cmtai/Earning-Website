                    ...
                    <SectionWrapper key={section.id} id={section.id} onVisible={setActiveSection}>
                      ...
                      {section.id === 'responsibilities' && (
                        <>
                          ...
                          <KeyTakeawayCard title="Key Takeaways">
                              <li className="flex items-start gap-3"><CheckCircle className="h-5 w-5 text-green-500 dark:text-teal-400 mt-1 flex-shrink-0" /><span>Complete your tasks honestly and maintain your Social Media channel.</span></li>
                          ...
                          <p>You are responsible for all activity on your account. This includes completing daily assignments genuinely, following Social Media's community guidelines with the AI content we provide, and maintaining the confidentiality of your login credentials.</p>
                      ...
                      {section.id === 'payments' && ( <><h2>Income & Payments</h2><p>Earnings are calculated based on completed tasks, Social Media revenue share, and referral commissions. Withdrawals are processed via UPI. We do not guarantee any specific level of income.</p></> )}
